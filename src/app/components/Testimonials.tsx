  ...
  return (
    <section>
      <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <h2 className="text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Read trusted reviews from our members</h2>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-lg font-medium text-gray-900">Ayush</p>
              </div>
            </div>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-lg font-medium text-gray-900">Shubham</p>
              </div>
            </div>
          ...
          <blockquote className="rounded-lg bg-gray-100 p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-lg font-medium text-gray-900">Narayan</p>
              </div>
            </div>
